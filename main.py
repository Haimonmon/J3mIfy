...
if __name__ == "__main__":
    ...
    sentences: List[str] = [
        ...
        "jeJemONz arE a~ Hapi BunCH. Jejejeje!! ~ thEY aRE @ctUallY nmeD d4hT w4y BeCos~ oF Th3ir~ VERy unIQUe l4ugHt3R~ - jejejeje! ThiZ TyP3 oF L4u9hT3R, s0m3 s@y, wuz oRig!nAllY uSeD bY oNl!ne mmoRPG g@meRz wHil3 tH3y pUmMeL oPp0n3nts 2h +h3 gRoUnD. Jejejejeje!"
    ]
